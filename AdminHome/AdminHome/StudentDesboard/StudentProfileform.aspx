<%@ Page Language="C#" MasterPageFile="~/StudentDesboard/StudentMasterPage.Master" AutoEventWireup="true" CodeBehind="StudentProfileform.aspx.cs" Inherits="AdminHome.StudentDesboard.StudentProfileform" %>
            ...
            <div class="col-lg-8">
                            ...
                            <div class="panel panel-default">
                                 <div class="panel-heading" style="text-align:center;background-color:#4CAF50;color: white;"><h4>Personal Information</h4></div>
                                    <div class="panel-body">
                                        <asp:Table runat="server" Font-Bold="true" CssClass="table">
                                                <asp:TableRow>
                            ...
                            <div class="panel panel-default">
                                 <div class="panel-heading" style="text-align:center;background-color:#4CAF50;color: white;"><h4>Accademic Information</h4></div>
                                    <div class="panel-body">
                                         <asp:Table ID="Table1" CssClass="table" runat="server" Font-Bold="true"> 
                                             <asp:TableRow>
