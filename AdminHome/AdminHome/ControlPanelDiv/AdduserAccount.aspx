<%@ Page Language="C#" MasterPageFile="~/usercontrolpage/ControlMasterPage.Master" AutoEventWireup="true" CodeBehind="AdduserAccount.aspx.cs" Inherits="AdminHome.ControlPanelDiv.AdduserAccount" %>
     ...
     <div class="container">
         <div class="col-lg-3"></div><div class="col-lg-6">
           <asp:Table ID="Table1" runat="server" CssClass="table">
               <asp:TableRow><asp:TableCell>Emp/Staff Id:</asp:TableCell><asp:TableCell><asp:DropDownList runat="server" CssClass="form-control" ID="ddlusername"></asp:DropDownList></asp:TableCell></asp:TableRow>
