<%@ Page Language="C#" MasterPageFile="~/usercontrolpage/ControlMasterPage.Master" AutoEventWireup="true" CodeBehind="SessionAdd.aspx.cs" Inherits="AdminHome.AdminSettingView.SectionAdd" %>
                ...
                <div class="row"><br /><br />
                    ...
                    <div class="col-lg-3">
                        <fieldset id="Fieldset1" runat="server">
                            <legend>Add/Update Session</legend><br />
                            <span>Session </span><asp:TextBox ID="txtsession" runat="server" CssClass="form-control"></asp:TextBox>
              ...
              PageSize="9" OnPageIndexChanging="mygride_PageIndexChanging" >
               <Columns>
                   ...
                   <ItemTemplate>
                           ...
                           <asp:LinkButton ID="lnlbtnedit" runat="server" ForeColor="Red" CommandArgument='<%# Eval("Id")+","+Eval("Session") %>' CommandName="ViewDetails" OnCommand="lnlbtnedit_Command" >
