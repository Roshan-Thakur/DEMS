<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/usercontrolpage/ControlMasterPage.Master" CodeBehind="AddBoard.aspx.cs" Inherits="AdminHome.AdminSettingView.AddBoard" %>
            ...
            <div class="container">
                <div class="row"><br />
                    <div class="col-lg-3">
                        <fieldset id="Fieldset1" runat="server">
                            <legend>Add/Update Board</legend><br />
                            <span>Board Name</span><asp:TextBox ID="txtboard" runat="server" CssClass="form-control"></asp:TextBox>
              ...
              PageSize="9" OnPageIndexChanging="mygride_PageIndexChanging" >
               <Columns>
                   ...
                   <asp:BoundField HeaderText="Class/Degree" DataField="board" />
                   ...
                   <ItemTemplate>
                           ...
                           <asp:LinkButton ID="lnlbtnedit" runat="server" ForeColor="Red" CommandArgument='<%# Eval("Id")+","+Eval("board") %>' CommandName="ViewDetails" OnCommand="lnlbtnedit_Command" >
