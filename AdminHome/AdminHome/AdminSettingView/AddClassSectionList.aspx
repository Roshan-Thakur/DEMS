<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/usercontrolpage/ControlMasterPage.Master" CodeBehind="AddClassSectionList.aspx.cs" Inherits="AdminHome.AdminSettingView.AddClassSectionList" %>
          ...
          <div class="container">
                ...
                <div class="col-lg-3">
                        <fieldset id="Fieldset1" runat="server">
                            <legend>Add/Update Class Section List</legend><br />
                            ...
                            <span>Section</span><asp:TextBox runat ="server" CssClass="form-control" ID="txtsection"></asp:TextBox>
              ...
              PageSize="9" OnPageIndexChanging="mygride_PageIndexChanging" >
               <Columns>
                   ...
                   <asp:BoundField HeaderText="Group" DataField="Grop" />
                   ...
                   <ItemTemplate>
                           ...
                           <asp:LinkButton ID="lnlbtnedit" runat="server" ForeColor="Red" CommandArgument='<%# Eval("Id")+","+Eval("cls")+","+Eval("Grop")+","+Eval("section") %>' CommandName="ViewDetails" OnCommand="lnlbtnedit_Command" >
