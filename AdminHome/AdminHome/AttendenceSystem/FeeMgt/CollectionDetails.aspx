<%@ Page Language="C#" MasterPageFile="~/usercontrolpage/ControlMasterPage.Master" AutoEventWireup="true" CodeBehind="CollectionDetails.aspx.cs" Inherits="AdminHome.AttendenceSystem.FeeMgt.CollectionDetails" %>
...
<body>
    ...
    <form id="form1" runat="server">
     <div class="container" style="background-color:whitesmoke;height:500px; margin-top:50px;">
    <div class="col-lg-12">       
