<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/usercontrolpage/ControlMasterPage.Master" CodeBehind="AttandanceReportHome.aspx.cs" Inherits="AdminHome.OriginalAttandenceSystem.AttandanceReportHome" %>
...
<body>
 <%--<form id="form1" runat="server" style="background-color:gray">--%>
   ...
   <div class="student-btn">
        <a href="AttandanceReportDiv.aspx" class="button"><span>Student Attendence</span></a></div></div>
    <div class="col-md-6">
